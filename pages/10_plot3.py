...
EXPERIMENTS = {
    'MDD': {
        'gptsmaller_guided': [(6201, 3111), (6201, 3117)],
        'gptlarge_guided': [(6201, 1121), (6201, 1123)],
        'claudesmaller_guided': [(6201, 3134), (6201, 3138)],
        'claudelarge_guided': [(6201, 1143), (6201, 1145)],
    },
    'BD': {
        'gptsmaller_guided': [(6202, 3211), (6202, 3212)],
        'gptlarge_guided': [(6202, 1221), (6202, 1222)],
        'claudesmaller_guided': [(6202, 3231), (6202, 3234)],
...
def create_psyche_plot(scores_data):
    ...
    ax.set_title('PACA Performance: PSYCHE Scores by Disorder and Model (Smaller vs Large)', 
...
def main():
    st.set_page_config(
        page_title="PSYCHE Score Plot 3",
        page_icon="📊",
        layout="wide"
    )
    ...
    # Page Header
    st.title("📊 PACA Performance Visualization - Smaller vs Large Models")
    st.markdown("---")
    ...
    with st.expander("ℹ️ 그래프 설명", expanded=True):
        ...
        **PSYCHE Score**로 시각화한 것입니다. (Smaller vs Large 모델 비교)
        ...
        **모양 및 패턴 (모델)**:
        ...
        ### 실험 번호:
        - **MDD**: gptsmaller (3111, 3117), gptlarge (1121, 1123), claudesmaller (3134, 3138), claudelarge (1143, 1145)
        - **BD**: gptsmaller (3211, 3212), gptlarge (1221, 1222), claudesmaller (3231, 3234), claudelarge (1241, 1242)
        - **OCD**: gptsmaller (3611, 3612), gptlarge (1621, 1622), claudesmaller (3631, 3632), claudelarge (1641, 1642)
        """)
