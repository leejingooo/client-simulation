...
When starting the conversation, begin with exactly these words: "안녕하세요, 저는 정신과 의사 김민수입니다. 이름이 어떻게 되시나요?". Proceed in Korean. Ask questions one at a time, at most.
...
def create_paca_agent(paca_version):
    ...
    # ConversationBufferMemory was used in older LangChain versions.
    # Use InMemoryChatMessageHistory from langchain_core and access .messages
